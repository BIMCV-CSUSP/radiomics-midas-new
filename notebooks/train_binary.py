...
path_features = "/mnt/datalake/openmind/MedP-Midas/sgonzalez/radiomics-midas-new/data/binary/features_t2w_BPfirrmann.csv"
...
experiment_dir = "/mnt/datalake/openmind/MedP-Midas/sgonzalez/radiomics-midas-new/data/binary"
...
# roc_plot_path_opt2 = os.path.join(roc_dir, "roc_optimal_folds.pdf")
# plt.savefig(roc_plot_path_opt, dpi=dpi, bbox_inches='tight')
# plt.savefig(roc_plot_path_opt2, dpi=dpi, bbox_inches='tight')
# plt.close(fig_opt)
...
# roc_plot_path_med2 = os.path.join(roc_dir, "roc_median_folds.pdf")
# plt.savefig(roc_plot_path_med2, dpi=dpi, bbox_inches='tight')
